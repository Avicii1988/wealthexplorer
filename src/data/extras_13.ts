...
export const extras_13: Record<string, Ext> = {
  ...
  'steve-harvey': {
    ...
    gossip: [
      { title: 'Media Empire Expansion', summary: 'Steve Harvey expanded his media holdings with new production deals and the Steve Harvey Global brand reaching new markets. His Family Feud hosting continues to dominate daytime television ratings.', type: 'gossip', date: 'Jun 2023' }
    ]
  },
  'stevie-wonder': {
    ...
    gossip: [
      { title: 'Relocating to Ghana', summary: 'Stevie Wonder publicly announced plans to relocate to Ghana citing concerns about racial inequality in the United States. He has made several extended visits to the country.', type: 'gossip', date: 'Sep 2023' }
    ]
  },
  'steph-balthazar': {
  ...
  'trevor-noah': {
    ...
    gossip: [
      { title: 'Post-Daily Show Global Tour', summary: 'Trevor Noah launched an extensive stand-up comedy tour after departing The Daily Show in 2022, performing to sold-out arenas across multiple continents. He also signed a major podcast deal.', type: 'gossip', date: 'Feb 2023' }
    ]
  },
  'ty-cobb': {
    avatar: 'https://ui-avatars.com/api/?name=Ty+Cobb&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'ty-cobb-1', type: 'real_estate', name: 'Georgia Estate', description: 'Historic estate in Royston, Georgia tied to the baseball legend.', estimatedValue: 0.25, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 440 },
      { id: 'ty-cobb-2', type: 'art', name: 'Baseball Memorabilia Collection', description: 'Rare collection of historic baseball cards and personal items from Cobb\'s career.', estimatedValue: 0.1, image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=900&h=600&fit=crop', likes: 380 }
    ],
    gossip: [
      { title: 'Legendary Legacy Revisited', summary: 'Ty Cobb\'s career batting average of .366 remains the highest in Major League Baseball history over a century after his playing days. Historians continue to debate his complex legacy both on and off the field.', type: 'gossip', date: 'Apr 2023' }
    ]
  },
  'usman-khawaja': {
  ...
  'victoria-beckham': {
    ...
    gossip: [
      { title: 'Fashion Empire Growth', summary: 'Victoria Beckham\'s fashion label celebrated its 15th anniversary with a major Paris Fashion Week showcase in 2023. The brand has expanded into beauty with a highly successful makeup line.', type: 'gossip', date: 'Oct 2023' }
    ]
  },
  'wyclef-jean': {
  ...
  'abubakar-atiku': {
    ...
    assets: [
      { id: 'abubakar-atiku-1', type: 'real_estate', name: 'Abuja Villa', description: 'Grand residence in Nigeria\'s capital reflecting his political stature.', estimatedValue: 0.35, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 520 },
      { id: 'abubakar-atiku-2', type: 'jet', name: 'Private Jet', description: 'Personal aircraft used for his extensive domestic and international travel.', estimatedValue: 0.2, image: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=900&h=600&fit=crop', likes: 680 }
    ],
    gossip: [
