...
export const extras_06: Record<string, Ext> = {
  'leon-black': {
    ...
    gossip: [
      { title: 'Apollo Global Exit', summary: 'Leon Black stepped down as CEO of Apollo Global Management in 2021 amid scrutiny over his ties to Jeffrey Epstein. He had paid Epstein over $158 million for tax and estate planning advice.', type: 'gossip', date: 'Mar 2021' }
    ]
  },
  'leonard-lauder': {
    avatar: 'https://ui-avatars.com/api/?name=Leonard+Lauder&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'leonard-lauder-1', type: 'art', name: 'Cubist Art Collection', description: 'One of the world\'s greatest private collections of Cubist art, donated to the Metropolitan Museum of Art in 2013.', estimatedValue: 1100, image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=900&h=600&fit=crop', likes: 780 },
      { id: 'leonard-lauder-2', type: 'real_estate', name: 'Manhattan Estate', description: 'A grand Manhattan residence befitting the Estée Lauder Companies\' chairman emeritus.', estimatedValue: 40, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 310 }
    ],
    gossip: [
      { title: 'Billion-Dollar Museum Gift', summary: 'Leonard Lauder donated 78 masterworks of Cubist art valued at over $1 billion to the Metropolitan Museum of Art in 2013. It remains one of the largest art donations in history.', type: 'gossip', date: 'Apr 2013' }
    ]
  },
  'lil-wayne': {
    ...
    gossip: [
      { title: 'Cash Money Legal Battle', summary: 'Lil Wayne sued his longtime label Cash Money Records and CEO Birdman for $51 million in 2015, alleging they blocked the release of his album Tha Carter V and withheld royalties.', type: 'gossip', date: 'Jan 2015' }
    ]
  },
  'lionel-messi': {
    ...
    gossip: [
      { title: 'Tax Fraud Conviction in Spain', summary: 'Lionel Messi and his father Jorge were convicted of tax fraud in Spain in 2016 for hiding €4.1 million in image rights income. Messi received a 21-month suspended sentence.', type: 'gossip', date: 'Jul 2016' }
    ]
  },
  'lisa-marie-presley': {
    ...
    gossip: [
      { title: 'Financial Troubles Despite Inheritance', summary: 'Despite inheriting Elvis Presley\'s estate, Lisa Marie Presley faced severe financial difficulties and reportedly lost most of her $100 million inheritance through mismanagement and lavish spending by a former manager.', type: 'gossip', date: 'Feb 2018' }
    ]
  },
  'll-cool-j': {
    ...
    gossip: [
      { title: 'NCIS: Los Angeles Longevity', summary: 'LL Cool J became one of the longest-serving cast members on NCIS: Los Angeles, appearing in all 14 seasons from 2009 to 2023 and earning a reported $125,000 per episode at his peak.', type: 'gossip', date: 'May 2023' }
    ]
  },
  'ludacris': {
    ...
    gossip: [
      { title: 'Fast & Furious Fortune', summary: 'Ludacris\'s role as Tej Parker in the Fast & Furious franchise significantly boosted his acting income, with the series grossing over $7 billion worldwide and becoming one of Hollywood\'s highest-earning franchises.', type: 'gossip', date: 'Jun 2021' }
    ]
  },
  'madonna': {
    ...
    gossip: [
      { title: 'Celebration Tour Record', summary: 'Madonna\'s Celebration Tour in 2023-2024 became one of the highest-grossing tours by a female artist, grossing over $225 million despite being delayed by a serious bacterial infection that hospitalized her in 2023.', type: 'gossip', date: 'Dec 2023' }
    ]
  },
  'magic-johnson': {
    ...
    gossip: [
      { title: 'HIV Announcement Turned Advocacy', summary: 'Magic Johnson announced his HIV-positive status in 1991 and retired from basketball, but went on to become one of the most prominent HIV/AIDS advocates in the world while building a billion-dollar business empire.', type: 'gossip', date: 'Nov 1991' }
    ]
  },
  'mariah-carey': {
    ...
    gossip: [
      { title: 'All I Want For Christmas Royalties', summary: 'Mariah Carey\'s 1994 holiday classic "All I Want For Christmas Is You" reportedly earns her around $3 million in royalties every holiday season, making it one of the most lucrative Christmas songs ever recorded.', type: 'gossip', date: 'Dec 2023' }
    ]
  },
  'mark-cuban': {
    ...
    gossip: [
      { title: 'Cost Plus Drugs Disruption', summary: 'Mark Cuban launched Cost Plus Drugs in 2022 to sell generic medications at drastically reduced prices, disrupting the pharmaceutical industry and drawing both praise from consumers and criticism from drug companies.', type: 'gossip', date: 'Jan 2022' }
    ]
  },
  'mark-zuckerberg': {
    ...
    gossip: [
      { title: 'MMA Training Obsession', summary: 'Mark Zuckerberg began training seriously in mixed martial arts and jiu-jitsu around 2023, winning gold medals at local MMA competitions and briefly challenging Elon Musk to a cage match that generated enormous media attention.', type: 'gossip', date: 'Jun 2023' }
    ]
  },
  'martha-stewart': {
    ...
    gossip: [
      { title: 'Prison and Comeback', summary: 'Martha Stewart served five months in federal prison in 2004 after being convicted of insider trading related to her ImClone stock sale. She rebuilt her media empire after release and remained a cultural icon.', type: 'gossip', date: 'Mar 2004' }
    ]
  },
  'matt-damon': {
    ...
    gossip: [
      { title: 'Crypto.com Ad Controversy', summary: 'Matt Damon starred in a widely criticized Crypto.com advertisement in 2021 saying "fortune favors the brave," which many blamed for encouraging ordinary people to invest in cryptocurrency before the 2022 market crash.', type: 'gossip', date: 'Oct 2021' }
    ]
  },
  'matthew-mcconaughey': {
    ...
    gossip: [
      { title: 'McConaissance', summary: 'After years of romantic comedies, Matthew McConaughey underwent a dramatic career resurgence dubbed the "McConaissance" from 2011 to 2014, culminating in his Academy Award win for Best Actor for Dallas Buyers Club.', type: 'gossip', date: 'Mar 2014' }
    ]
  },
  'meghan-markle': {
    ...
    gossip: [
      { title: 'Royal Exit and Netflix Deal', summary: 'Meghan Markle and Prince Harry signed a reported $100 million deal with Netflix in 2020 after stepping back from royal duties, producing documentaries and the explosive Harry & Meghan series released in 2022.', type: 'gossip', date: 'Sep 2020' }
    ]
  },
  'melissa-mccarthy': {
    ...
    gossip: [
      { title: 'Bridesmaids Breakthrough', summary: 'Melissa McCarthy\'s scene-stealing performance in the 2011 comedy Bridesmaids earned her an Academy Award nomination for Best Supporting Actress and launched her into Hollywood\'s A-list, leading to a string of blockbuster comedies.', type: 'gossip', date: 'May 2011' }
    ]
  },
  'meryl-streep': {
    ...
    gossip: [
      { title: 'Record Oscar Nominations', summary: 'Meryl Streep holds the record for the most Academy Award nominations of any actor with 21 nominations and three wins, making her widely regarded as the greatest living actress in Hollywood.', type: 'gossip', date: 'Jan 2023' }
    ]
  },
  'michael-jordan': {
    ...
    gossip: [
      { title: 'Nike Deal Worth Billions', summary: 'Michael Jordan\'s partnership with Nike, which began in 1984 with the Air Jordan line, has grown into a multi-billion dollar empire with Jordan Brand generating over $5 billion annually, earning Jordan approximately $150 million per year.', type: 'gossip', date: 'Jun 2023' }
    ]
  },
  'michael-phelps': {
    ...
    gossip: [
      { title: 'Mental Health Advocacy', summary: 'Michael Phelps, the most decorated Olympian of all time with 23 gold medals, has spoken openly about his struggles with depression and suicidal thoughts, becoming a prominent mental health advocate since his retirement.', type: 'gossip', date: 'Jan 2018' }
    ]
  },
  'michael-schumacher': {
    ...
    gossip: [
      { title: 'Skiing Accident Secrecy', summary: 'Michael Schumacher suffered a severe traumatic brain injury in a skiing accident in December 2013. His family has kept his medical condition almost entirely private since, with few official updates on his recovery.', type: 'gossip', date: 'Dec 2013' }
    ]
  },
  'mick-jagger': {
    ...
    gossip: [
      { title: 'Heart Surgery at 75', summary: 'Mick Jagger underwent emergency heart valve replacement surgery in 2019 at age 75, yet returned to touring with the Rolling Stones just months later, performing to sold-out stadiums around the world.', type: 'gossip', date: 'Apr 2019' }
    ]
  },
  'mike-tyson': {
    ...
    gossip: [
      { title: 'Bankruptcy After Earning $300 Million', summary: 'Mike Tyson earned an estimated $300 million during his boxing career but filed for bankruptcy in 2003, having spent lavishly on mansions, exotic animals including pet tigers, and extravagant personal expenses.', type: 'gossip', date: 'Aug 2003' }
    ]
  },
  'miley-cyrus': {
    ...
    gossip: [
      { title: 'Flowers Grammy Win', summary: 'Miley Cyrus won her first Grammy Awards in 2024 for "Flowers," which became one of the fastest songs to reach one billion streams on Spotify and was widely interpreted as a response to her ex-husband Liam Hemsworth.', type: 'gossip', date: 'Feb 2024' }
    ]
  },
  'muhammad-ali': {
    ...
    gossip: [
      { title: 'Vietnam Draft Refusal', summary: 'Muhammad Ali refused induction into the US military in 1967, citing his religious beliefs and opposition to the Vietnam War. He was stripped of his boxing titles and banned from fighting for three years at the peak of his career.', type: 'gossip', date: 'Apr 1967' }
    ]
  },
  'nadia-comaneci': {
    ...
    gossip: [
      { title: 'Perfect Ten in Montreal', summary: 'At the 1976 Montreal Olympics, Nadia Comaneci became the first gymnast to score a perfect 10, a feat so unprecedented that the scoreboard could not display it and showed 1.00 instead, marking a historic moment in sports.', type: 'gossip', date: 'Jul 1976' }
    ]
  },
  'naomi-campbell': {
    ...
    gossip: [
      { title: 'Phone-Throwing Incidents', summary: 'Naomi Campbell pleaded guilty in 2008 to assaulting a police officer and was charged multiple times for throwing mobile phones at staff, resulting in community service sentences that made international headlines throughout the 2000s.', type: 'gossip', date: 'May 2008' }
    ]
  },
  'natalie-portman': {
    ...
    gossip: [
      { title: 'Harvard During Star Wars', summary: 'Natalie Portman attended Harvard University while filming the Star Wars prequels, graduating with a psychology degree in 2003 and later going on to study at Hebrew University in Jerusalem, demonstrating her commitment to academics alongside acting.', type: 'gossip', date: 'Jun 2003' }
    ]
  },
  'nba-youngboy': {
    avatar: 'https://ui-avatars.com/api/?name=NBA+YoungBoy&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'nba-youngboy-1', type: 'real_estate', name: 'Utah Compound', description: 'NBA YoungBoy relocated his family to a large compound in Utah while under house arrest, purchasing the property to accommodate his children and their mothers.', estimatedValue: 2, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 380 }
    ],
    gossip: [
      { title: 'Most Viewed YouTube Artist', summary: 'NBA YoungBoy became the most-viewed artist on YouTube in the United States in 2020 and 2021, surpassing established superstars while simultaneously dealing with legal issues and house arrest.', type: 'gossip', date: 'Dec 2021' }
    ]
  },
  'neil-young': {
    ...
    gossip: [
      { title: 'Spotify Withdrawal Over Misinformation', summary: 'Neil Young demanded Spotify remove his music in January 2022, protesting the platform\'s hosting of Joe Rogan\'s podcast which he accused of spreading COVID-19 misinformation. Spotify chose to keep Rogan, and Young\'s catalog was removed.', type: 'gossip', date: 'Jan 2022' }
    ]
  },
  'neymar': {
    ...
    gossip: [
      { title: 'World Record Transfer Fee', summary: 'Neymar\'s transfer from Barcelona to Paris Saint-Germain in 2017 set a world record transfer fee of €222 million, nearly doubling the previous record and signaling a new era of astronomical spending in European football.', type: 'gossip', date: 'Aug 2017' }
    ]
  },
}
