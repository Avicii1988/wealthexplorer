...
export const extras_15: Record<string, Ext> = {
  'awa-traore': {
  ...
  'banda-nkhosi': {
    ...
    assets: [
      { id: 'banda-nkhosi-1', type: 'real_estate', name: 'Malawian Estate', description: 'Historic estate once belonging to Malawi\'s founding president.', estimatedValue: 0.3, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 280 }
    ],
    gossip: [
  ...
  'bilal-erdogan': {
    ...
    assets: [
      { id: 'bilal-erdogan-1', type: 'yacht', name: 'Mediterranean Yacht', description: 'Luxury yacht used for cruising the Turkish and Aegean coastlines.', estimatedValue: 0.25, image: 'https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=900&h=600&fit=crop', likes: 670 },
      { id: 'bilal-erdogan-2', type: 'real_estate', name: 'Istanbul Mansion', description: 'Grand residence in one of Istanbul\'s most coveted neighborhoods.', estimatedValue: 0.1, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 490 }
    ],
    gossip: [
  ...
  'bongani-zulu': {
    ...
    assets: [
      { id: 'bongani-zulu-1', type: 'real_estate', name: 'Yaounde Villa', description: 'Luxurious villa in Cameroon\'s capital city, home base for the football legend.', estimatedValue: 0.06, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 1050 },
      { id: 'bongani-zulu-2', type: 'car', name: 'Ferrari 488', description: 'Prancing horse supercar from Samuel Eto\'o\'s personal collection.', estimatedValue: 0.025, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 780 }
    ],
    gossip: [
  ...
  'brian-lara': {
    ...
    assets: [
      { id: 'brian-lara-1', type: 'real_estate', name: 'Trinidad Estate', description: 'Elegant home in Trinidad where the batting legend remains a national icon.', estimatedValue: 0.025, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 860 }
    ],
    gossip: [
