...
export const extras_17: Record<string, Ext> = {
  'diplo': {
    ...
    assets: [
      { id: 'diplo-1', type: 'real_estate', name: 'Los Angeles Home', description: 'Modern LA residence used as a creative hub for music production.', estimatedValue: 0.008, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 310 },
  ...
  'abel-makkonen': {
    ...
    assets: [
      ...
      { id: 'abel-makkonen-2', type: 'car', name: 'Lamborghini Aventador', description: 'Custom Lamborghini featured in several of his music videos and red carpet appearances.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 1420 }
    ],
    gossip: [
  ...
  'abby-wambach': {
    ...
    assets: [
      { id: 'abby-wambach-1', type: 'real_estate', name: 'Portland Family Home', description: 'Comfortable Pacific Northwest home shared with wife Glennon Doyle and family.', estimatedValue: 0.007, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 390 }
    ],
    gossip: [
  ...
  'afrobeats-burna-boy': {
    ...
    assets: [
      { id: 'afrobeats-burna-boy-1', type: 'real_estate', name: 'Lagos Mansion', description: 'Sprawling Lagos estate reflecting his Nigerian roots and Afrobeats superstar status.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 720 },
      { id: 'afrobeats-burna-boy-2', type: 'car', name: 'Rolls-Royce Cullinan', description: 'Signature luxury SUV driven across Lagos and frequently seen at industry events.', estimatedValue: 0.003, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 610 }
    ],
    gossip: [
  ...
  'anne-marie': {
    ...
    assets: [
      { id: 'anne-marie-1', type: 'real_estate', name: 'London Apartment', description: 'Stylish London flat in a sought-after neighborhood, reflecting her pop star success.', estimatedValue: 0.009, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 420 }
    ],
    gossip: [
  ...
  'archie-harrison': {
    ...
    assets: [
      { id: 'archie-harrison-1', type: 'real_estate', name: 'Montecito Estate', description: 'The $14.7 million Montecito mansion purchased after stepping back from royal duties, set on 5.4 acres.', estimatedValue: 0.015, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 2100 }
    ],
    gossip: [
  ...
  'ashley-tisdale': {
    ...
    assets: [
      { id: 'ashley-tisdale-1', type: 'real_estate', name: 'Studio City Home', description: 'Beautifully renovated Studio City property frequently featured on her lifestyle social media.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 510 }
    ],
    gossip: [
  ...
  'austin-butts': {
    ...
    assets: [
      { id: 'austin-butts-1', type: 'car', name: 'Vintage Muscle Car', description: 'Classic American muscle car befitting the actor\'s transformation into Elvis Presley.', estimatedValue: 0.002, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 380 }
    ],
    gossip: [
  ...
  'baraka-donn': {
    ...
    assets: [
      { id: 'baraka-donn-1', type: 'real_estate', name: 'Atlanta Residence', description: 'Home base in Atlanta shared with her sister Chloe Bailey as the duo rose to fame.', estimatedValue: 0.003, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 440 }
    ],
    gossip: [
  ...
  'becky-g': {
    ...
    assets: [
      { id: 'becky-g-1', type: 'real_estate', name: 'Inglewood Family Home', description: 'Family home in Inglewood, California, where Becky G grew up and still supports her extended family.', estimatedValue: 0.004, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 520 }
    ],
    gossip: [
  ...
  'billie-lourd': {
    ...
    assets: [
      { id: 'billie-lourd-1', type: 'real_estate', name: 'Los Angeles Estate', description: 'Inherited property and personal LA home reflecting her Hollywood dynasty lineage.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 360 }
    ],
    gossip: [
  ...
  'bogdan-popescu': {
    ...
    assets: [
      { id: 'bogdan-popescu-1', type: 'real_estate', name: 'Belgrade Apartment', description: 'Family home in Belgrade where the Djokovic family raised tennis legend Novak.', estimatedValue: 0.0005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 120 }
    ],
    gossip: [
  ...
  'cassie-ventura': {
    ...
    assets: [
      { id: 'cassie-ventura-1', type: 'real_estate', name: 'Los Angeles Home', description: 'Comfortable LA residence where she has rebuilt her life after high-profile personal challenges.', estimatedValue: 0.003, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 290 }
    ],
    gossip: [
  ...
  'cedric-diallo': {
    ...
    assets: [
      { id: 'cedric-diallo-1', type: 'real_estate', name: 'Bondy Apartment', description: 'Family home in Bondy, the Paris suburb where Kylian Mbappe grew up and learned to play football.', estimatedValue: 0.0005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 95 }
    ],
    gossip: [
      { title: 'Fayza Lamari Manages Mbappe Empire', summary: 'Kylian Mbappe\'s mother Fayza Lamari, not his father Wilfried, has served as his primary agent and manager throughout his career. The family\'s tight control over Mbappe\'s image and contracts has been widely noted in football circles.', type: 'gossip', date: 'Jul 2022' }
    ]
  },
  'chadwick-boseman': {
    avatar: 'https://ui-avatars.com/api/?name=Chadwick+Boseman&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'chadwick-boseman-1', type: 'real_estate', name: 'Los Angeles Home', description: 'LA residence where the Black Panther star lived while battling cancer privately for four years.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 1450 }
    ],
    gossip: [
  ...
  'charlie-sheen': {
    ...
    assets: [
      { id: 'charlie-sheen-1', type: 'real_estate', name: 'Mulholland Estates Home', description: 'Former luxury home in Mulholland Estates, sold during financial difficulties following his Two and a Half Men departure.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 340 }
    ],
    gossip: [
  ...
  'chiara-ferragni': {
    ...
    assets: [
      { id: 'chiara-ferragni-1', type: 'real_estate', name: 'Milan Penthouse', description: 'Stylish Milan penthouse frequently featured in her fashion content and brand campaigns.', estimatedValue: 0.008, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 1120 },
      { id: 'chiara-ferragni-2', type: 'art', name: 'Contemporary Art Collection', description: 'Curated collection of contemporary Italian and international art displayed throughout her Milan home.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=900&h=600&fit=crop', likes: 640 }
    ],
    gossip: [
  ...
  'christian-pulisic': {
    ...
    assets: [
      { id: 'christian-pulisic-1', type: 'car', name: 'Porsche 911', description: 'Sports car favored by the US soccer star during his time playing in Europe.', estimatedValue: 0.002, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 480 }
    ],
    gossip: [
  ...
  'claire-foy': {
    ...
    assets: [
      { id: 'claire-foy-1', type: 'real_estate', name: 'London Home', description: 'Understated London home reflecting the actress\'s preference for privacy over celebrity.', estimatedValue: 0.005, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 320 }
    ],
    gossip: [
  ...
  'claude-giroux': {
    ...
    assets: [
      { id: 'claude-giroux-1', type: 'real_estate', name: 'Ottawa Home', description: 'Family residence in Ottawa following his move to the Senators, close to his Quebec roots.', estimatedValue: 0.002, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 270 },
      { id: 'claude-giroux-2', type: 'car', name: 'Mercedes-Benz GLE', description: 'Luxury SUV favored by the veteran NHL star for family transportation.', estimatedValue: 0.001, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 180 }
    ],
    gossip: [
  ...
  'colin-kaepernick': {
    ...
    assets: [
      { id: 'colin-kaepernick-1', type: 'real_estate', name: 'Los Angeles Home', description: 'LA base from which he has continued his activism and media work since leaving the NFL.', estimatedValue: 0.008, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 640 }
    ],
    gossip: [
  ...
  'courtney-love': {
    ...
    assets: [
      { id: 'courtney-love-1', type: 'real_estate', name: 'Los Angeles Victorian', description: 'Eccentric Victorian-style Los Angeles home reflecting her unique artistic personality.', estimatedValue: 0.009, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 420 }
    ],
    gossip: [
  ...
  'curren-y': {
    ...
    assets: [
      { id: 'curren-y-1', type: 'car', name: 'Classic Car Collection', description: 'Enviable collection of classic lowriders and vintage American cars, a passion well-documented in his music and videos.', estimatedValue: 0.003, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 390 }
    ],
    gossip: [
      { title: 'Independent Label Pioneer', summary: 'Curren$y built a loyal following and sustainable music career through his Jet Life Recordings independent label, releasing dozens of mixtapes and albums. He is widely cited as a blueprint for artists seeking to maintain independence from major labels.', type: 'gossip', date: 'Feb 2020' }
    ]
  },
}
