...
export const extras_16: Record<string, Ext> = {
  'sylvester-stallone': {
    ...
    relationships: {
      ...
      exSpouse: ['Sasha Czack', 'Brigitte Nielsen'],
      children: ['Sage Stallone', 'Seargeoh Stallone', 'Sophia Stallone', 'Sistine Stallone', 'Scarlet Stallone'],
    }
  },
  'sza': {
    avatar: av('SZA'),
  ...
  'the-weeknd': {
    ...
    relationships: {
      exPartner: ['Bella Hadid', 'Selena Gomez'],
    }
  },
  'tiger-woods': {
  ...
  'tim-duncan': {
    ...
    relationships: {
      exSpouse: ['Amy Duncan'],
      children: ['Sydney Duncan', 'Draven Duncan'],
    }
  },
  'tom-brady': {
    avatar: av('Tom Brady'),
  ...
  'tom-cruise': {
    ...
    relationships: {
      exSpouse: ['Mimi Rogers', 'Nicole Kidman', 'Katie Holmes'],
  ...
  'tony-parker': {
    ...
    relationships: {
      exSpouse: ['Eva Longoria'],
      children: ['Josh Parker', 'Liam Parker'],
    }
  },
  'travis-kalanick': {
  ...
  'tyson-fury': {
    ...
    relationships: {
      spouse: 'Paris Fury',
      children: ['Venezuela Fury', 'Prince John James Fury', 'Prince Tyson Fury II', 'Valencia Amber Fury', 'Odyssey Prince Fury', 'Athena Fury'],
    }
  },
  'usain-bolt': {
    ...
    relationships: {
      ...
      children: ['Olympia Lightning Bolt', 'Saint Leo Bolt', 'Thunder Bolt'],
    }
  },
  'usher': {
    avatar: av('Usher'),
    ...
    relationships: {
      spouse: 'Jennifer Goicoechea',
      exSpouse: ['Tameka Foster'],
      children: ['Usher Raymond V', 'Naviyd Ely Raymond', 'Sovereign Bo Raymond', 'Sire Castrello Raymond'],
    }
  },
  'venus-williams': {
  ...
  'wayne-gretzky': {
    ...
    relationships: {
      spouse: 'Janet Jones',
      children: ['Paulina Gretzky', 'Ty Gretzky', 'Trevor Gretzky', 'Tristan Gretzky', 'Emma Gretzky'],
    }
  },
  'wayne-rooney': {
    ...
    relationships: {
      spouse: 'Coleen Rooney',
      children: ['Kai Wayne Rooney', 'Klay Anthony Rooney', 'Kit Joseph Rooney', 'Cass Mac Rooney'],
    }
  },
  'whitney-wolfe-herd': {
    ...
    relationships: {
      spouse: 'Michael Herd',
      children: ['Bobby Lee Herd', 'Charlie Herd'],
    }
  },
  'will-smith': {
