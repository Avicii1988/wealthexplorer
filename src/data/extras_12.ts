...
export const extras_12: Record<string, Ext> = {
  'katharine-hepburn': {
    ...
    gossip: [
      { title: 'Hollywood Legend', summary: 'Katharine Hepburn won four Academy Awards for Best Actress, a record that still stands today. She was known for her fierce independence and refusal to conform to Hollywood norms.', type: 'gossip', date: 'Jan 2003' }
    ]
  },
  'keith-urban': {
    ...
    gossip: [
      { title: 'Grammy-Winning Country Star', summary: 'Keith Urban has sold over 15 million albums worldwide and won four Grammy Awards. He met and married actress Nicole Kidman in 2006 after a whirlwind romance.', type: 'gossip', date: 'Mar 2021' }
    ]
  },
  'kim-kardashian': {
    ...
    gossip: [
      { title: 'SKIMS Billionaire Status', summary: 'Kim Kardashian\'s shapewear brand SKIMS reached a valuation of $4 billion in 2023, cementing her status as a self-made billionaire. She also passed the bar exam in 2021 and advocates for criminal justice reform.', type: 'gossip', date: 'Jul 2023' }
    ]
  },
  'kylie-jenner': {
    ...
    gossip: [
      { title: 'Kylie Cosmetics Empire', summary: 'Kylie Jenner founded Kylie Cosmetics at age 17, which she later sold a majority stake in to Coty Inc. for $600 million. She remains one of the most followed people on Instagram with over 400 million followers.', type: 'gossip', date: 'Nov 2022' }
    ]
  },
  'lance-armstrong': {
    ...
    gossip: [
      { title: 'Doping Scandal Fallout', summary: 'Lance Armstrong was stripped of his seven Tour de France titles in 2012 after admitting to systematic doping throughout his career. He has since worked to rebuild his public image through podcasting and business ventures.', type: 'gossip', date: 'Jan 2013' }
    ]
  },
  'lil-nas-x': {
  ...
  'logan-paul': {
    ...
    gossip: [
      { title: 'PRIME Hydration Success', summary: 'Logan Paul co-founded PRIME Hydration with KSI in 2022, which became one of the fastest-growing beverage brands in history and reached $1.2 billion in retail sales within its first year. He also competed professionally in boxing matches against Floyd Mayweather.', type: 'gossip', date: 'Jun 2023' }
    ]
  },
  'lori-harvey': {
  ...
  'marvin-gaye': {
    ...
    gossip: [
      { title: 'What\'s Going On Legacy', summary: 'Marvin Gaye\'s 1971 album "What\'s Going On" is widely regarded as one of the greatest albums ever recorded, addressing war, poverty, and environmental issues. His estate continues to earn significant royalties from his timeless catalog.', type: 'gossip', date: 'May 1971' }
    ]
  },
  'michael-jordan': {
    ...
    gossip: [
      { title: 'Charlotte Hornets Sale', summary: 'Michael Jordan sold his majority stake in the Charlotte Hornets in 2023, ending his run as one of the few Black majority owners in professional sports. The team sold for approximately $3 billion, netting Jordan a massive profit.', type: 'gossip', date: 'Jun 2023' }
    ]
  },
  'michael-strahan': {
    ...
    gossip: [
      { title: 'Space Tourism Pioneer', summary: 'Michael Strahan flew to space aboard Blue Origin\'s New Shepard rocket in December 2021, becoming one of the first celebrities to experience suborbital spaceflight. He continues to co-host Good Morning America alongside his media work.', type: 'gossip', date: 'Dec 2021' }
    ]
  },
  'mike-tyson': {
    ...
    gossip: [
      { title: 'Cannabis Empire Comeback', summary: 'Mike Tyson founded Tyson 2.0, a cannabis company that has grown into a multi-million dollar business with products sold across the United States. He fought Jake Paul in a professional boxing match in 2024, drawing global attention.', type: 'gossip', date: 'Nov 2024' }
    ]
  },
  'missy-elliott': {
    ...
    gossip: [
      { title: 'Rock and Roll Hall of Fame Induction', summary: 'Missy Elliott became the first female hip-hop artist inducted into the Rock and Roll Hall of Fame in 2023, a historic milestone. She is also the first female rapper to have six albums certified platinum by the RIAA.', type: 'gossip', date: 'Nov 2023' }
    ]
  },
  'nelson-mandela': {
  ...
  'nick-fury-real': {
    avatar: 'https://ui-avatars.com/api/?name=Nick+Cannon&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'nick-fury-real-1', type: 'real_estate', name: 'Los Angeles Home', description: 'A spacious Los Angeles residence accommodating his large family, purchased during his peak earning years.', estimatedValue: 0.018, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 420 }
    ],
    gossip: [
      { title: 'Record-Breaking Family', summary: 'Nick Cannon made headlines for fathering 12 children with multiple women, becoming one of the most talked-about celebrities for his unconventional family life. He hosts The Masked Singer and his own talk show simultaneously.', type: 'gossip', date: 'Dec 2022' }
    ]
  },
  'nile-rodgers': {
    ...
    gossip: [
      { title: 'Hitmaker Extraordinaire', summary: 'Nile Rodgers has produced some of the best-selling albums in history, including records for David Bowie, Madonna, Daft Punk, and Diana Ross. His song "Le Freak" by Chic remains the best-selling single in the history of Atlantic Records.', type: 'gossip', date: 'Jun 2013' }
    ]
  },
  'olivia-wilde': {
    ...
    gossip: [
      { title: 'Don\'t Worry Darling Controversy', summary: 'Olivia Wilde\'s directorial effort "Don\'t Worry Darling" generated significant buzz not only for its cast but also for backstage drama involving Florence Pugh and Harry Styles. The film grossed over $67 million worldwide despite the controversy.', type: 'gossip', date: 'Sep 2022' }
    ]
  },
  'oscar-piastri': {
  ...
  'paris-hilton': {
    ...
    gossip: [
      { title: 'Business Empire Revealed', summary: 'Paris Hilton\'s business empire extends well beyond her socialite image, with her 11:11 Media company and numerous licensing deals generating over $15 million annually. She is credited with inventing the influencer model long before social media existed.', type: 'gossip', date: 'Mar 2021' }
    ]
  },
  'paul-pogba': {
    ...
    gossip: [
      { title: 'Doping Suspension', summary: 'Paul Pogba received a four-year doping ban in 2023, which was later reduced to 18 months on appeal, effectively ending his prime footballing years. He previously won the FIFA World Cup with France in 2018 and was the world\'s most expensive player in 2016.', type: 'gossip', date: 'Sep 2023' }
    ]
  },
  'pharrell-williams': {
    ...
    gossip: [
      { title: 'Louis Vuitton Creative Director', summary: 'Pharrell Williams was appointed Creative Director of Louis Vuitton\'s men\'s division in 2023, following the passing of Virgil Abloh. His debut collection received widespread acclaim and signaled a new era for the iconic luxury house.', type: 'gossip', date: 'Feb 2023' }
    ]
  },
  'prince-harry': {
    avatar: 'https://ui-avatars.com/api/?name=Prince+Harry&background=1a1a1a&color=c9a84c&size=200&bold=true',
    assets: [
      { id: 'prince-harry-1', type: 'real_estate', name: 'Montecito Estate', description: 'A $14.65 million estate in Montecito, California, purchased in 2020 after stepping back from royal duties.', estimatedValue: 0.015, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 1800 }
    ],
    gossip: [
      { title: 'Spare Memoir Controversy', summary: 'Prince Harry\'s memoir "Spare" became the fastest-selling nonfiction book in history upon its January 2023 release, detailing tensions within the British royal family. The Duke of Sussex reportedly earned over $20 million from Netflix and Spotify deals combined.', type: 'gossip', date: 'Jan 2023' }
    ]
  },
  'prince-william': {
    ...
    gossip: [
      { title: 'Earthshot Prize Initiative', summary: 'Prince William launched the Earthshot Prize in 2020, a prestigious environmental award offering £1 million annually to innovators solving the world\'s greatest environmental challenges. The prize has attracted global attention and major corporate sponsors.', type: 'gossip', date: 'Oct 2021' }
    ]
  },
  'queen-elizabeth-ii': {
    ...
    gossip: [
      { title: 'Britain\'s Longest-Reigning Monarch', summary: 'Queen Elizabeth II became Britain\'s longest-reigning monarch in 2015, surpassing Queen Victoria\'s record of 63 years and 216 days. She passed away on September 8, 2022 at Balmoral Castle at the age of 96, ending a 70-year reign.', type: 'gossip', date: 'Sep 2022' }
    ]
  },
  'randy-orton': {
    ...
    gossip: [
      { title: 'The Viper\'s Return', summary: 'Randy Orton made a triumphant return to WWE in 2023 after nearly two years away due to back surgery, receiving one of the biggest crowd reactions in recent wrestling history. He is a 14-time world champion and one of the most decorated wrestlers in WWE history.', type: 'gossip', date: 'Nov 2023' }
    ]
  },
  'rob-lowe': {
    ...
    gossip: [
      { title: 'Brat Pack Pioneer', summary: 'Rob Lowe was one of the original members of the celebrated Brat Pack in the 1980s, starring in classics like "The Outsiders" and "St. Elmo\'s Fire." He later reinvented his career with acclaimed television roles in "The West Wing" and "Parks and Recreation."', type: 'gossip', date: 'Jan 2019' }
    ]
  },
  'rob-kardashian': {
  ...
  'roberto-mancini': {
    ...
    gossip: [
      { title: 'Euro 2020 Triumph', summary: 'Roberto Mancini led Italy to victory at UEFA Euro 2020, ending the nation\'s 53-year wait for a major international trophy. He later took charge of the Saudi Arabia national team in 2023 following Italy\'s failure to qualify for the 2022 World Cup.', type: 'gossip', date: 'Jul 2021' }
    ]
  },
  'sean-combs': {
    ...
    gossip: [
      { title: 'Legal Troubles and Arrest', summary: 'Sean "Diddy" Combs was arrested in September 2024 and charged with sex trafficking, racketeering, and other serious crimes, sending shockwaves through the music industry. He founded Bad Boy Records and produced hits for Notorious B.I.G., Mary J. Blige, and many others.', type: 'gossip', date: 'Sep 2024' }
    ]
  },
  'serge-gnabry': {
    ...
    gossip: [
      { title: 'Champions League Hero', summary: 'Serge Gnabry scored four goals against Tottenham Hotspur in a single Champions League match in 2019, one of the most stunning individual performances in the competition\'s modern era. He has been a key player for Bayern Munich and the German national team.', type: 'gossip', date: 'Oct 2019' }
    ]
  },
}
