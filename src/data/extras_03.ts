...
export const extras_03: Record<string, Ext> = {
  'carl-lewis': {
    ...
    relationships: { parents: ['William Lewis (†)', 'Evelyn Lewis'], siblings: ['Cleveland Lewis', 'Mack Lewis', 'Carol Lewis'] }
  },
  'carlos-alcaraz': {
    ...
    relationships: { parents: ['Carlos Alcaraz González', 'Virginia Garfia'] }
  },
  'carlos-santana': {
    ...
    relationships: { exSpouse: ['Deborah King'], spouse: 'Cindy Blackman', children: ['Salvador Santana', 'Stella Santana', 'Angelica Santana'] }
  },
  'carlos-slim': {
    ...
    relationships: { exSpouse: ['Soumaya Domit (†)'], children: ['Carlos Slim Domit', 'Marco Antonio Slim Domit', 'Patrick Slim Domit', 'Soumaya Slim Domit', 'Vanessa Slim Domit', 'Johanna Slim Domit'] }
  },
  'cate-blanchett': {
    ...
    relationships: { spouse: 'Andrew Upton', children: ['Dashiell John Upton', 'Roman Robert Upton', 'Ignatius Martin Upton', 'Edith Vivian Patricia Upton'] }
  },
  'charlie-munger': {
    ...
    relationships: { exSpouse: ['Nancy Huggins'], spouse: 'Nancy Borthwick (†)', children: ['Molly Munger', 'Wendy Munger', 'Emilie Munger', 'Barry Munger', 'Charles Munger Jr.', 'Teddy Munger (†)'] }
  },
  'charlize-theron': {
    ...
    relationships: { exPartner: ['Sean Penn', 'Stuart Townsend'], children: ['Jackson Theron', 'August Theron'] }
  },
  'chen-guangbiao': {
    ...
    relationships: { spouse: 'Zheng Jinyan', children: ['Chen Yuning', 'Chen Xuning'] }
  },
  'chidi-odinkalu': {
  ...
  'chito-vera': {
    ...
    relationships: { partner: 'Leticia Cruz', children: ['Mia Vera'] }
  },
  'chris-brown': {
    ...
    relationships: { children: ['Royalty Brown', 'Aeko Catori Brown', 'Lovely Symphani Brown'] }
  },
  'chris-evans': {
    ...
    relationships: { spouse: 'Alba Baptista', siblings: ['Scott Evans'] }
  },
  'chris-hemsworth': {
    ...
    relationships: { spouse: 'Elsa Pataky', siblings: ['Liam Hemsworth', 'Luke Hemsworth'], children: ['India Rose Hemsworth', 'Tristan Hemsworth', 'Sasha Hemsworth'] }
  },
  'chris-martin': {
    ...
    relationships: { exSpouse: ['Gwyneth Paltrow'], partner: 'Dakota Johnson', children: ['Apple Martin', 'Moses Martin'] }
  },
  'chris-paul': {
    ...
    relationships: { spouse: 'Jada Crawley', children: ['Christopher Emanuel Paul II', 'Camryn Alexis Paul'] }
  },
  'chris-pratt': {
    ...
    relationships: { exSpouse: ['Anna Faris'], spouse: 'Katherine Schwarzenegger', children: ['Jack Pratt', 'Lyla Maria Schwarzenegger Pratt', 'Eloise Christina Schwarzenegger Pratt'] }
  },
  'chris-tucker': {
    ...
    relationships: { exSpouse: ['Azja Pryor'], children: ['Destin Christopher Tucker'] }
  },
  'christian-horner': {
    ...
    relationships: { spouse: 'Geri Halliwell', children: ['Olivia Horner', 'Montague George Hector Horner'] }
  },
  'cindy-crawford': {
    ...
    relationships: { exSpouse: ['Richard Gere'], spouse: 'Rande Gerber', children: ['Presley Gerber', 'Kaia Gerber'] }
  },
  'claudia-sheinbaum': {
    ...
    relationships: { exSpouse: ['Carlos Ímaz Gispert'], spouse: 'Jesús María Tarriba Unger', children: ['Rodrigo Ímaz Sheinbaum'] }
  },
  'colman-domingo': {
    ...
    relationships: { spouse: 'Raúl Domingo' }
  },
  'conan-obrien': {
    ...
    relationships: { spouse: 'Liza Powel', children: ['Neve Obrien', 'Beckett Obrien'] }
  },
  'connie-chiume': {
  ...
  'conor-mcgregor': {
    ...
    relationships: { partner: 'Dee Devlin', children: ['Conor Jack McGregor Jr.', 'Croia McGregor', 'Rían McGregor', 'Mack McGregor'] }
  },
  'cormac-mccarthy': {
    ...
    relationships: { exSpouse: ['Lee Holleman', 'Jennifer Winkley'], children: ['Cullen McCarthy', 'John Francis McCarthy'] }
  },
  'cristiano-ronaldo': {
    ...
    relationships: { partner: 'Georgina Rodríguez', children: ['Cristiano Ronaldo Jr.', 'Eva Maria Dos Santos', 'Mateo Ronaldo', 'Alana Martina Dos Santos Aveiro', 'Bella Esmeralda'] }
  },
  'cyril-ramaphosa': {
    ...
    relationships: { exSpouse: ['Nomazizi Mtshotshisa', 'Hope Ramaphosa'], spouse: 'Tshepo Motsepe', children: ['Andile Ramaphosa', 'Tulisa Ramaphosa', 'Tumelo Ramaphosa', 'Michaela Ramaphosa'] }
  },
  'daddy-yankee': {
    ...
    relationships: { exSpouse: ['Mireddys González'], children: ['Jesaaelys Ayala González', 'Yamilette Ayala González'] }
  },
  'dak-prescott': {
    ...
    relationships: { partner: 'Sarah Jane Ramos' }
  },
  'dalai-lama': {
    ...
    relationships: { parents: ['Choekyong Tsering (†)', 'Diki Tsering (†)'], siblings: ['Lobsang Samten (†)', 'Gyalo Thondup', 'Thubten Jigme Norbu (†)', 'Jetsun Pema'] }
  },
  'dame-dash': {
    avatar: av('Dame Dash'),
    ...
    relationships: { exPartner: ['Rachel Roy', 'Aaliyah (†)'], children: ['Damon Dash II', 'Ava Dash', 'Tallulah Dash'] }
  },
  'damian-lillard': {
    ...
    relationships: { exPartner: ["Kay'La Hanson"], children: ['Damian Lillard Jr.', 'Kali Lillard'] }
  },
  'dana-white': {
    ...
    relationships: { spouse: 'Anne White', children: ['Dana White III', 'Aidan White', 'Savannah White'] }
  },
  'daniel-craig': {
    ...
    relationships: { exPartner: ['Fiona Loudon'], spouse: 'Rachel Weisz', children: ['Ella Craig', 'unnamed daughter with Weisz'] }
  },
  'danilo-gallinari': {
    ...
    relationships: { parents: ['Vittorio Gallinari', 'Rosa Gallinari'] }
  },
}
