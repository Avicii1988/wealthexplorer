...
export const extras_05: Record<string, Ext> = {
  ...
  'dave-chappelle': {
    ...
    relationships: { spouse: 'Elaine Chappelle', children: ['Sulayman Chappelle', 'Ibrahim Chappelle', 'Sonal Chappelle'] }
  },
  'dave-grohl': {
    ...
    relationships: { exSpouse: ['Jennifer Youngblood'], spouse: 'Jordyn Blum', children: ['Violet Maye Grohl', 'Harper Willow Grohl', 'Ophelia Saint Grohl'] }
  },
  'david-beckham': {
    ...
    relationships: { spouse: 'Victoria Beckham', children: ['Brooklyn Beckham', 'Romeo Beckham', 'Cruz Beckham', 'Harper Seven Beckham'] }
  },
  'david-copperfield-magician': {
    ...
    relationships: { partner: 'Chloe Gosselin', children: ['Sky Gosselin Copperfield'] }
  },
  'david-hasselhoff': {
    ...
    relationships: { exSpouse: ['Catherine Hickland', 'Pamela Bach'], children: ['Taylor Ann Hasselhoff', 'Hayley Amber Hasselhoff'] }
  },
  'davidoff-yachts': {
  ...
  'dean-martin': {
    ...
    relationships: { exSpouse: ['Elizabeth Anne McDonald', 'Jeanne Biegger', 'Catherine Hawn'], children: ['Craig Martin (†)', 'Claudia Martin', 'Barbara Martin', 'Gail Martin', 'Dean Paul Martin (†)', 'Deana Martin', 'Ricci Martin (†)', 'Sasha Martin'] }
  },
  'deepika-chikhalia': {
    ...
    relationships: { spouse: 'Hemant Topiwala', children: ['Bhavya Topiwala', 'Manjari Topiwala'] }
  },
  'deepika-padukone': {
    ...
    relationships: { spouse: 'Ranveer Singh', children: ['Dua Padukone Singh'] }
  },
  'degrassi-drake': {
    avatar: av('Drake'),
    assets: [
  ...
  'demi-lovato': {
    ...
    relationships: { exPartner: ['Wilmer Valderrama', 'Max Ehrich'] }
  },
  'denzel-curry': {
  ...
  'denzel-washington': {
    ...
    relationships: { spouse: 'Pauletta Washington', children: ['John David Washington', 'Katia Washington', 'Malcolm Washington', 'Olivia Washington'] }
  },
  'derek-black': {
  ...
  'derek-jeter': {
    ...
    relationships: { spouse: 'Hannah Davis', children: ['Bella Raine Jeter', 'Story Grey Jeter', 'River Rose Jeter'] }
  },
  'desmond-tutu': {
    ...
    relationships: { spouse: 'Leah Nomalizo Shenxane', children: ['Trevor Thamsanqa Tutu', 'Theresa Thandeka Tutu', 'Naomi Nontombi Tutu', 'Mpho Andrea Tutu'] }
  },
  'didier-drogba': {
    ...
    relationships: { exSpouse: ['Lalla Diaby'], children: ['Isaac Drogba', 'Iman Drogba', 'Kéita Drogba'] }
  },
  'dikembe-mutombo': {
    ...
    relationships: { spouse: 'Rose Mutombo', children: ['Biamba Marie', 'Carrie', 'Ryan', 'Isha', 'Jean-Jacques', 'Chloe Vanessa', 'Emma'] }
  },
  'dimitri-payet': {
    ...
    relationships: { spouse: 'Ludivine Payet', children: ['Noa Payet', 'Mathys Payet', 'Milan Payet'] }
  },
  'dirk-nowitzki': {
    ...
    relationships: { spouse: 'Jessica Olsson', children: ['Malaika', 'Max', 'Morris'] }
  },
  'doja-cat': {
    avatar: av('Doja Cat'),
    ...
    relationships: { parents: ['Dumisani Dlamini', 'Deborah Elizabeth Sawyer'] }
  },
  'dolly-parton': {
    ...
    relationships: { spouse: 'Carl Thomas Dean' }
  },
  'donald-trump': {
    ...
    relationships: { exSpouse: ['Ivana Trump (†)', 'Marla Maples'], spouse: 'Melania Trump', children: ['Donald Trump Jr.', 'Ivanka Trump', 'Eric Trump', 'Tiffany Trump', 'Barron Trump'] }
  },
  'doutzen-kroes': {
    ...
    relationships: { spouse: 'Sunnery James', children: ['Phyllon Joy Gorré', 'Myllena Mae Gorré'] }
  },
  'dr-dre': {
    avatar: av('Dr Dre'),
    assets: [
    ...
    relationships: { exPartner: ["Michel'le", 'Lisa Johnson', 'Nicole Young'], children: ['La Tanya Young', 'Marcel Young', 'Truly Young', 'Curtis Young', 'Andre Young Jr. (†)'] }
  },
  'dua-lipa': {
    avatar: av('Dua Lipa'),
    ...
    relationships: { parents: ['Dukagjin Lipa', 'Anesa Lipa'], siblings: ['Gjin Lipa', 'Rina Lipa'], exPartner: ['Anwar Hadid', 'Isaac Carew'] }
  },
  'dustin-johnson': {
    ...
    relationships: { fiancé: 'Paulina Gretzky', children: ['Tatum Gretzky Johnson', 'River Jones Johnson'] }
  },
  'dwayne-johnson': {
    ...
    relationships: { exSpouse: ['Dany Garcia'], partner: 'Lauren Hashian', children: ['Simone Alexandra Johnson', 'Jasmine Johnson', 'Tiana Gia Johnson'] }
  },
  'dwyane-wade': {
    ...
    relationships: { exSpouse: ['Siovaughn Funches'], spouse: 'Gabrielle Union', children: ['Zaire Blessing Dwyane Wade', 'Zaya Wade', 'Xavier Zechariah Wade', 'Kaavia James Union Wade'] }
  },
  'ed-sheeran': {
    ...
    relationships: { spouse: 'Cherry Seaborn', children: ['Lyra Antarctica Seaborn Sheeran', 'Jupiter Seaborn Sheeran'] }
  },
  'eddie-murphy': {
    ...
    relationships: { exSpouse: ['Nicole Mitchell'], partner: 'Paige Butcher', children: ['Bria Murphy', 'Myles Murphy', 'Shayne Murphy', 'Zola Ivy Murphy', 'Bella Zahra Murphy', 'Angel Iris Murphy Brown', 'Izzy Oona Murphy', 'Max Charles Murphy', 'Eric Murphy'] }
  },
  'eden-hazard': {
    ...
    relationships: { spouse: 'Natacha Van Honacker', siblings: ['Thorgan Hazard', 'Kylian Hazard', 'Ethan Hazard'], children: ['Yannis Hazard', 'Leo Hazard', 'Samy Hazard', 'Estelle Hazard'] }
  },
  'elton-john': {
    ...
    relationships: { exSpouse: ['Renate Blauel'], spouse: 'David Furnish', children: ['Zachary Jackson Levon Furnish-John', 'Elijah Joseph Daniel Furnish-John'] }
  },
}
