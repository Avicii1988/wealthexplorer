...
export const extras_18: Record<string, Ext> = {
  ...
  'davy-klaassen': {
    ...
    assets: [
      { id: 'davy-klaassen-1', type: 'real_estate', name: 'Amsterdam Property', description: 'A modern property in Amsterdam near Ajax\'s training facilities, reflecting his deep ties to the club.', estimatedValue: 0.012, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 160 }
    ],
    gossip: [
  ...
  'degrassi-aubrey': {
    ...
    assets: [
      { id: 'degrassi-aubrey-1', type: 'real_estate', name: 'Toronto Mega-Mansion', description: 'A lavish mansion in Toronto known as YOLO Estate, featuring a full-size basketball court and recording studio.', estimatedValue: 0.1, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop', likes: 1200 },
      { id: 'degrassi-aubrey-2', type: 'jet', name: 'Air Drake Custom Boeing 767', description: 'A custom Boeing 767 nicknamed Air Drake, reportedly gifted by Cargojet and outfitted with luxury interiors.', estimatedValue: 0.085, image: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=900&h=600&fit=crop', likes: 2100 }
    ],
    gossip: [
  ...
  'dougie-b': {
    ...
    assets: [
      { id: 'dougie-b-1', type: 'car', name: 'Custom Street Car', description: 'A customized vehicle reflecting the Brooklyn drill scene aesthetic that defines his music and persona.', estimatedValue: 0.01, image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=900&h=600&fit=crop', likes: 130 }
    ],
    gossip: [
      { title: 'Brooklyn Drill Scene Pioneer', summary: 'Dougie B emerged as a prominent figure in Brooklyn\'s drill music scene, collaborating with major artists and helping define the sound of New York\'s youth culture in the early 2020s. His viral tracks helped bring Brooklyn drill to a global mainstream audience.', type: 'gossip', date: 'Mar 2022' }
    ]
  },
  'dr-phil': {
